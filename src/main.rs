...
fn problem_11() -> String {
  ...
  let grid: Vec<u8> = vec![
    08, 02, 22, 97, 38, 15, 00, 40, 00, 75, 04, 05, 07, 78, 52, 12, 50, 77, 91, 08, 49, 49, 99, 40, 17, 81, 18, 57, 60, 87, 17, 40, 98, 43,
...
//   let mut prime_factors: Vec<(u64, u64)> = Vec::new();
//   let mut num = n;
...
//     } else {
//       if exp > 0 {
//         prime_factors.push((primes[p_idx], exp));
//       }
//       exp = 0;
//       p_idx += 1;
//     }
...
fn factor_count_v2(n: u64, primes: &Vec<u64>) -> u64 {
  if n == 1 || n == 2 || n == 3 {
    return n;
  }
  let mut p_idx: usize = 0;
...
fn add_large_nums(a: String, b: String) -> String {
...
fn collatz_seq_len(start: u64) -> u64 {
  let mut chain_len = 1;
  let mut num = start;
